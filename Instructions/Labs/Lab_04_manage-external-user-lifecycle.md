...
### Exercise 1 - Microsoft Entra ID Governance settings
...
1. In **Identity Governance | Control configurations**, locate **Lifecycle of external users**, and then select **View settings**.
...
1. In the **Lifecycle of external users** pane, review the available settings for external users.
